...
const PROPERTIES_TO_SEED: SeedProperty[] = [
  ...
  // --- 1. Villa ---
  {
    ...
    description: 'A magnificent estate located in the prestigious North 90th Street of New Cairo. Featuring state-of-the-art home automation, private swimming pools, and beautifully landscaped gardens. Perfect for upscale family living with spacious rooms, a separate driver room, and maid quarters.',
    price: 35000000,
    currency: 'EGP',
    area: 650,
    address: {
  ...
  },
  {
    ...
    description: 'A spectacular modern mansion in Riyadh\'s prestigious Golden Square district. This property combines classic Najdi architectural elements with contemporary high-end luxury interiors. It offers huge terraces, expansive garden spaces, double-height ceilings in the main lobby, and complete privacy.',
    price: 8500000,
    currency: 'USD',
    area: 920,
    address: {
  ...
  // --- 2. Apartment ---
  {
    ...
    description: 'A luxurious apartment located on the upper floors of a premium tower in London, overlooking the Thames. It features panoramic views of the city, high-end marble flooring, and access to a shared clubhouse and private elevator.',
    price: 3200000,
    currency: 'EUR',
    area: 180,
    address: {
  ...
  },
  {
    ...
    description: 'Located in the family-friendly Dubai Marina district, this apartment offers close proximity to pristine beaches and high-end shopping malls. Upper floor unit with spacious balcony overlooking the yachts.',
    price: 1200000,
    currency: 'USD',
    area: 165,
    address: {
  ...
  // --- 3. Chalet ---
  {
    ...
    description: 'Breathtaking first-row sea view chalet in Marassi (Sidi Abdel Rahman). Directly overlooking the pristine Mediterranean beach. High-end modern furnishings, spacious terrace, and steps away from the water.',
    price: 18000000,
    currency: 'EGP',
    area: 150,
    address: {
  ...
  },
  {
    ...
    description: 'Beautiful chalet in Miami Beach with direct Atlantic Ocean frontage. Offers a private garden space, outdoor dining deck, private beach lounge access, and premium resort privileges.',
    price: 1850000,
    currency: 'USD',
    area: 175,
    address: {
  ...
  // --- 4. Office ---
  {
    ...
    description: 'State-of-the-art office floor in Midtown Manhattan. Fully finished with meeting rooms, executive boardrooms, reception lobby, server room, and high-speed fiber optic connection.',
    price: 5500000,
    currency: 'USD',
    area: 320,
    address: {
  ...
  },
  {
    ...
    description: 'An executive office space situated in the prestigious Doha West Bay District, close to the central bank. Fully furnished with modular desks, shared business lounge, and dedicated secure parking slots.',
    price: 2400000,
    currency: 'USD',
    area: 140,
    address: {
  ...
  // --- 5. Restaurant ---
  {
    ...
    description: 'A premium restaurant space in the heart of Paris. Complete with professional gas lines, high-capacity exhaust ventilation hoods, dual industrial prep-kitchens, and a beautiful outdoor dining patio area.',
    price: 3800000,
    currency: 'EUR',
    area: 300,
    address: {
  ...
  },
  {
    ...
    description: 'A spectacular restaurant property overlooking the Nile in Zamalek. High foot traffic location with upscale clientele. The layout includes indoor dining halls, bar space, and terrace seating.',
    price: 22000000,
    currency: 'EGP',
    area: 210,
    address: {
  ...
  // --- 6. Warehouse ---
  {
    ...
    description: 'A large modern warehouse with double-height ceiling in the Berlin outskirts. Features 4 heavy-duty loading docks, automated fire sprinkler system, and full flat-bed truck turnaround access.',
    price: 4500000,
    currency: 'EUR',
    area: 1800,
    address: {
  ...
  },
  {
    ...
    description: 'A specialized insulated warehouse equipped with advanced cooling systems. Perfect for pharmaceutical storage or fresh food logistics in Jeddah Port Industrial Zone.',
    price: 4800000,
    currency: 'USD',
    area: 1400,
    address: {
  ...
  // --- 7. Factory ---
  {
    ...
    description: 'Industrial manufacturing plant with high electrical power capacity (1000 KW), structural overhead gantry crane tracks, administrative offices block, and industrial effluent drainage lines.',
    price: 8500000,
    currency: 'EUR',
    area: 4000,
    address: {
  ...
  },
  {
    ...
    description: 'Cleanroom assembly floor designed for electronics, consumer goods, or pharmaceuticals. Climate-controlled, dust-free ventilation, and epoxy anti-static flooring.',
    price: 9200000,
    currency: 'EUR',
    area: 2400,
    address: {
  ...
  // --- 8. Retail ---
  {
    ...
    description: 'A double-height retail showroom in the historic Korba district of Heliopolis. Perfect for luxury brands, automotive showrooms, or premium cosmetics. Highly visible layout with large window facades.',
    price: 48000000,
    currency: 'EGP',
    area: 400,
    address: {
  ...
  },
  {
    ...
    description: 'A commercial retail space in one of Rome\'s busiest shopping streets. Features high foot traffic, dual entrances, full service meters, and dedicated signboards area.',
    price: 2400000,
    currency: 'EUR',
    area: 150,
    address: {
  ...
  // --- 9. Medical ---
  {
    ...
    description: 'A luxury fully-equipped dental clinic in central Madrid. Contains central air lines, specialized medical sanitation room, recovery lounge, and digital radiology setup space.',
    price: 1200000,
    currency: 'EUR',
    area: 120,
    address: {
  ...
  },
  {
    ...
    description: 'Spacious child-friendly clinic with multiple examination chambers, soundproofed consultation zones, vaccine storage space, and kids entertainment area.',
    price: 1800000,
    currency: 'USD',
    area: 250,
    address: {
  ...
  // --- 10. Hotel ---
  {
    ...
    description: 'A landmark resort in Hurghada featuring private lagoons, full spa treatment centers, multiple international standard dining avenues, conference halls, and premium sea-view guest keys.',
    price: 450000000,
    currency: 'EGP',
    area: 25000,
    address: {
  ...
  },
  {
    ...
    description: 'A cozy boutique hotel located in the heart of Sharm El Sheikh. Offers intimate premium accommodation, rooftop lounge bar, immediate pedestrian promenade access, and high occupancy history.',
    price: 24000000,
    currency: 'USD',
    area: 8500,
    address: {
  ...
  // --- 11. Motel ---
  {
    ...
    description: 'A transit highway motel located at the junction of Sokhna. Features easy drive-up parking spaces in front of each room, quick service rest stop diner, and complete logistical service facilities.',
    price: 3800000,
    currency: 'USD',
    area: 3200,
    address: {
  ...
  },
  {
    ...
    description: 'Transit motel and reststop in Ras Sudr on the main highway leading to Sharm. Ideal for quick check-ins, transit travelers, and surfers looking for affordable rooms near the coast.',
    price: 24000000,
    currency: 'EGP',
    area: 2500,
    address: {
  ...
  // --- 12. Resort ---
  {
    ...
    description: 'Stunning premium resort overlooking Abu Tig Marina in El Gouna. Combines private beaches, custom yacht parking berths, championship golf course, spa clubs, and luxury suites.',
    price: 680000000,
    currency: 'EGP',
    area: 45000,
    address: {
  ...
  },
  {
    ...
    description: 'Located in the exclusive Soma Bay peninsula, this resort offers high-end spa therapies, windsurfing centers, signature golf greens, and breathtaking panoramic sea views from all suites.',
    price: 520000000,
    currency: 'EGP',
    area: 38000,
    address: {
  ...
  // --- 13. Camp ---
  {
    ...
    description: 'An eco-friendly beach campsite in Dahab near the Blue Hole. Features structured bamboo tents, communal dining circles, clean shared showers, and solar power stations.',
    price: 6000000,
    currency: 'EGP',
    area: 1800,
    address: {
  ...
  },
  {
    ...
    description: 'Traditional bedouin beach camp in Nuweiba. Rest and relax right on the Gulf of Aqaba. Authentic reed huts, beach firepits, fresh sea meals, and deep starry sky views.',
    price: 4500000,
    currency: 'EGP',
    area: 1500,
    address: {
  ...
  // --- 14. Land ---
  {
    ...
    description: 'A rectangular flat corner land plot situated in Shorouk City. Excellent construction footprint permission, fully serviced with water, electricity, and sewage lines at the boundary.',
    price: 18000000,
    currency: 'EGP',
    area: 1200,
    address: {
  ...
  },
  {
    ...
    description: 'An exclusive residential villa plot located in West Somid, 6th of October City. High elevation, double-road facing corner. Perfect for building a custom villa with large yard space.',
    price: 12000000,
    currency: 'EGP',
    area: 950,
    address: {
...
async function getOrCreateFeature(
  ...
  slug: string,
  icon: string,
  featureGroup: 'lifestyle' | 'security' | 'utilities' | 'amenities'
): Promise<number> {
  const found = await payload.find({
    collection: 'features',
    where: { name: { equals: name } },
...
async function getOrCreatePropertyType(
  ...
  name: string,
  slug: string,
  specificationProfile: 'villa' | 'apartment' | 'chalet' | 'office' | 'restaurant' | 'warehouse' | 'factory' | 'retail' | 'medical' | 'hotel' | 'motel' | 'resort' | 'camp' | 'land' | 'none',
  categorySlug: string,
...
const BASE_LOCATIONS = [
  { city: 'Riyadh', state: 'Riyadh Province', country: 'Saudi Arabia', lat: 24.7136, lng: 46.6753, zip: '11564' },
  { city: 'London', state: 'Greater London', country: 'United Kingdom', lat: 51.5074, lng: -0.1278, zip: 'EC1A 1BB' },
  { city: 'Dubai', state: 'Dubai', country: 'United Arab Emirates', lat: 25.2048, lng: 55.2708, zip: '00000' },
  { city: 'New York', state: 'New York', country: 'United States', lat: 40.7128, lng: -74.0060, zip: '10001' },
  { city: 'Paris', state: 'Île-de-France', country: 'France', lat: 48.8566, lng: 2.3522, zip: '75001' },
  { city: 'Berlin', state: 'Berlin State', country: 'Germany', lat: 52.5200, lng: 13.4050, zip: '10115' },
  { city: 'Jeddah', state: 'Makkah Province', country: 'Saudi Arabia', lat: 21.4858, lng: 39.1925, zip: '21146' },
  { city: 'Rome', state: 'Lazio', country: 'Italy', lat: 41.9028, lng: 12.4964, zip: '00100' },
  { city: 'Madrid', state: 'Madrid Community', country: 'Spain', lat: 40.4168, lng: -3.7038, zip: '28001' },
  { city: 'Kuwait City', state: 'Al Asimah', country: 'Kuwait', lat: 29.3759, lng: 47.9774, zip: '13001' },
  { city: 'New Cairo', state: 'Cairo', country: 'Egypt', lat: 30.0074, lng: 31.4913, zip: '11835' },
  { city: 'Sheikh Zayed', state: 'Giza', country: 'Egypt', lat: 30.0632, lng: 30.9661, zip: '12588' },
  { city: 'Al Alamein', state: 'Matrouh', country: 'Egypt', lat: 30.9922, lng: 28.7328, zip: '51718' },
  { city: 'New Capital', state: 'Cairo', country: 'Egypt', lat: 29.9880, lng: 31.7050, zip: '11956' },
]
...
async function main() {
  ...
  const readyStatusId = await getOrCreateConstructionStatus(payload, 'Ready to Move In', 'ready', 'emerald')
  const underConstructionStatusId = await getOrCreateConstructionStatus(payload, 'Under Construction', 'under_construction', 'amber')
  ...
  const defaultPropertyTypes = [
    ...
    { name: 'Retail Shop', slug: 'retail-shop', profile: 'retail' as const, categorySlug: 'commercial' },
    { name: 'Restaurant', slug: 'restaurant', profile: 'restaurant' as const, categorySlug: 'commercial' },
    ...
    { name: 'Warehouse', slug: 'warehouse', profile: 'warehouse' as const, categorySlug: 'commercial' },
    ...
    { name: 'Business Center', slug: 'business-center', profile: 'office' as const, categorySlug: 'commercial' },
    { name: 'Coworking Space', slug: 'coworking-space', profile: 'office' as const, categorySlug: 'commercial' },
    { name: 'Commercial Building', slug: 'commercial-building', profile: 'none' as const, categorySlug: 'commercial' },
    { name: 'Mixed Use Building', slug: 'mixed-use-building', profile: 'none' as const, categorySlug: 'commercial' },

    // Residential
    { name: 'Apartment', slug: 'apartment', profile: 'apartment' as const, categorySlug: 'residential' },
    ...
    { name: 'Penthouse', slug: 'penthouse', profile: 'villa' as const, categorySlug: 'residential' },
    { name: 'Villa', slug: 'villa', profile: 'villa' as const, categorySlug: 'residential' },
    { name: 'Townhouse', slug: 'townhouse', profile: 'villa' as const, categorySlug: 'residential' },
    { name: 'Twin House', slug: 'twin-house', profile: 'villa' as const, categorySlug: 'residential' },
    ...
    { name: 'Farm House', slug: 'farm-house', profile: 'villa' as const, categorySlug: 'residential' },
    ...
    { name: 'Compound Unit', slug: 'compound-unit', profile: 'none' as const, categorySlug: 'residential' },
    { name: 'Serviced Apartment', slug: 'serviced-apartment', profile: 'apartment' as const, categorySlug: 'residential' },
    ...
    { name: 'Boutique Hotel', slug: 'boutique-hotel', profile: 'hotel' as const, categorySlug: 'hospitality' },
    ...
    { name: 'Aparthotel', slug: 'aparthotel', profile: 'hotel' as const, categorySlug: 'hospitality' },
    { name: 'Hotel Apartment', slug: 'hotel-apartment', profile: 'hotel' as const, categorySlug: 'hospitality' },
    ...
    { name: 'Guest House', slug: 'guest-house', profile: 'motel' as const, categorySlug: 'hospitality' },
    { name: 'Hostel', slug: 'hostel', profile: 'motel' as const, categorySlug: 'hospitality' },
    { name: 'Bed & Breakfast', slug: 'bed-and-breakfast', profile: 'motel' as const, categorySlug: 'hospitality' },
    { name: 'Camp', slug: 'camp', profile: 'camp' as const, categorySlug: 'hospitality' },
    { name: 'Glamping Site', slug: 'glamping-site', profile: 'camp' as const, categorySlug: 'hospitality' },
    { name: 'Holiday Village', slug: 'holiday-village', profile: 'resort' as const, categorySlug: 'hospitality' },

    // Land
    { name: 'Residential Land', slug: 'residential-land', profile: 'land' as const, categorySlug: 'land' },
    { name: 'Commercial Land', slug: 'commercial-land', profile: 'land' as const, categorySlug: 'land' },
    { name: 'Industrial Land', slug: 'industrial-land', profile: 'land' as const, categorySlug: 'land' },
    { name: 'Agricultural Land', slug: 'agricultural-land', profile: 'land' as const, categorySlug: 'land' },
    { name: 'Mixed-Use Land', slug: 'mixed-use-land', profile: 'land' as const, categorySlug: 'land' },
    { name: 'Investment Land', slug: 'investment-land', profile: 'land' as const, categorySlug: 'land' },
    ...
    { name: 'Mountain Land', slug: 'mountain-land', profile: 'land' as const, categorySlug: 'land' },
    { name: 'Island', slug: 'island', profile: 'land' as const, categorySlug: 'land' },
    { name: 'Development Site', slug: 'development-site', profile: 'land' as const, categorySlug: 'land' },
    { name: 'Building Plot', slug: 'building-plot', profile: 'land' as const, categorySlug: 'land' },
  ]
  ...
  const featuresList = [
    { name: 'Infinity Edge Pool', slug: 'infinity-edge-pool', icon: 'Waves', featureGroup: 'lifestyle' as const },
    { name: '24/7 Gated Community Security', slug: '24-7-gated-community-security', icon: 'Shield', featureGroup: 'security' as const },
    { name: 'High-Speed Fiber WiFi', slug: 'high-speed-fiber-wifi', icon: 'Wifi', featureGroup: 'utilities' as const },
    { name: 'Central Air Conditioning', slug: 'central-air-conditioning', icon: 'Wind', featureGroup: 'amenities' as const },
    { name: 'Extensive Landscaped Garden', slug: 'extensive-landscaped-garden', icon: 'Trees', featureGroup: 'lifestyle' as const },
    { name: 'Underground Parking Garage', slug: 'underground-parking-garage', icon: 'Car', featureGroup: 'utilities' as const },
  ]
  const featureIds: number[] = []
  for (const feat of featuresList) {
    const id = await getOrCreateFeature(payload, feat.name, feat.slug, feat.icon, feat.featureGroup)
    featureIds.push(id)
  }
  ...
  for (const pt of defaultPropertyTypes) {
    ...
    for (let i = 0; i < remainingToCreate; i++) {
      ...
      finalPropertiesToSeed.push({
        ...
        price: pt.categorySlug === 'land' ? 8000000 + generatedIndex * 500000 : 12000000 + generatedIndex * 1000000,
        currency: 'EGP',
  ...
  console.log(`📊 Total properties prepared for seeding: ${finalPropertiesToSeed.length} (covers all 55 types, 2 per type)`)
  ...
  const projectMediaId = await ensureMediaFile(payload, 'building-dreamy.jpg', 'Project Development Layout Plan')
  ...
  for (const prop of finalPropertiesToSeed) {
    ...
    if (!typeDoc) {
      console.warn(`⚠️ Skipped seeding "${prop.title}": property type slug "${prop.typeSlug}" not registered.`)
      continue
    }

    const typeId = typeDoc.id
    const categorySlug = typeDoc.category && typeof typeDoc.category === 'object' 
    ...
    if (!imageMediaId) {
      console.warn(`⚠️ Skipped seeding "${prop.title}": media not resolved for "${prop.imageFile}".`)
      continue
    }
