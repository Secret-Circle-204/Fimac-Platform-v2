...
export const defaultPropertyTypes = [
  ...
  { name: 'Office', slug: 'office', categorySlug: 'commercial', specificationProfile: 'office' },
  {
    ...
    specificationProfile: 'retail',
  },
  {
    name: 'Restaurant',
    slug: 'restaurant',
    categorySlug: 'commercial',
    specificationProfile: 'restaurant',
  },
  ...
  },
  {
    ...
    slug: 'warehouse',
    categorySlug: 'commercial',
    specificationProfile: 'warehouse',
  },
  ...
  // Residential
  {
    ...
    specificationProfile: 'apartment',
  },
  {
    name: 'Studio',
    slug: 'studio',
    ...
    for (const item of defaultPropertyTypes) {
      ...
      if (!categoryId) {
        payload.logger.error(
          `❌ [Seeder]: Category '${item.categorySlug}' not found. Skipping '${item.name}'`,
        )
        continue
      }
