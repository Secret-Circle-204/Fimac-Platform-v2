...
function DialogContent({
  className,
  children,
  bypassCentering = false,
  ...props
}: React.ComponentProps<typeof DialogPrimitive.Content> & {
  bypassCentering?: boolean
}) {
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          !bypassCentering && 'top-[50%] left-[50%] max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] rounded-lg border p-6 sm:max-w-lg',
          className,
        )}
        {...props}
      >
