...
export const metadata: Metadata = {
  ...
  description:
    'FIMAC Group connects buyers with premium hotels, resorts, commercial assets, and residential real estate globally. Contact our advisors for off-market hospitality investments.',
  keywords: [
...
export default async function HomePage() {
  ...
  const parsedPhones = parsePhoneNumbers(settings.contactPhone)
  ...
  const structuredData = {
    ...
    name: 'FIMAC Group',
    description:
      'FIMAC is a premier real estate platform offering global properties, luxury hotels, residential real estate, commercial assets, and expert consulting.',
    url: SERVER_URL,
    ...
    ...(parsedPhones.length > 0
      ? {
          telephone:
            parsedPhones.length === 1 ? parsedPhones[0].telUri : parsedPhones.map((p) => p.telUri),
        }
      : {}),
            ...
            <section className="py-16 bg-background text-foreground">
              <div className="container mx-auto px-4">
                <div className="max-w-3xl mx-auto text-center">
                  {aboutPage.heroTitle && (
                    <h2 className="text-3xl font-bold mb-6">{aboutPage.heroTitle}</h2>
                  )}
                  <p className="text-muted-foreground mb-6">{aboutPage.heroDescription}</p>
                  <Button
            ...
            <div className="container relative mx-auto px-4">
              <div className="flex flex-col tablet:flex-row bg-background/90 rounded-lg overflow-hidden shadow-2xl border border-white/10">
                <FadeIn className="tablet:w-1/2 p-12 flex flex-col justify-center space-y-6">
                  <h2 className="text-3xl font-bold">Ready to Find Your world Propertie?</h2>
