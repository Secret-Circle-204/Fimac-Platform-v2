...
export const Features: CollectionConfig = {
  ...
  fields: [
    ...
    },
    {
      ...
      label: 'Feature Group',
      options: [
        { label: 'Interior & Amenities', value: 'interior' },
        { label: 'Outdoor Features', value: 'outdoor' },
        { label: 'Security & Safety', value: 'security' },
        { label: 'Parking & Transportation', value: 'parking' },
        ...
        { label: 'Agriculture & Farm', value: 'agriculture' },
        { label: 'Sustainability & Green', value: 'sustainability' },
